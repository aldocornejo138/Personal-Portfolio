      ...
      >
        <div className="flex flex-col lgl:flex-row justify-between gap-4 lgl:gap-0 lgl:items-center">
          <div>
            ...
            <p className="text-sm mt-2 text-gray-400 group-hover:text-qhite duration-300">
              {subTitle}
            </p>
          </div>
          <div>
            <p
              className="px-4 py-2 text-designColor bg-black bg-opacity-25 rounded-lg flex
            justify-center items-center shadow-shadowOne text-sm font-medium"
            >
              {result}
            </p>
          </div>
        ...
        <div>
          <p
            className="text-sm md:test-base font-medium text-gray-400 group-hover:text-gray-300
                duration-300"
          >
            {des}
          </p>
