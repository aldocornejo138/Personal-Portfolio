...
const ProjectsCard = ({ title, des, src, link, githubLink }) => {
  return (
    <div
      className="w-full py-4 xl:px-12 h-auto xl:py-10 rounded-lg shadow-shadowOne flex flex-col 
    ...
    >
      ...
      <div className="w-full mt-5 flex flex-col gap-6">
        <div>
          ...
          <p className="text-sm tracking-wide mt-3 hover:text-gray-100 duration-300 sm:pl-4">
            {des}
          </p>
        </div>
      </div>
