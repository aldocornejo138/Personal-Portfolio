          ...
          <div className="w-full">
            <div className="w-full h-[500px] flex justify-between">
              ...
              >
                ...
                />
                <div>
                  <p className="test-xs uppercase text-designColor tracking-wide mb-2">
                    Bound-Trolola
                  </p>
              ...
              <div className="w-[60%] h-full flex flex-col justify-between">
                ...
                <div
                  className="w-full h-[70%] py-10 bg-gradient-to-r from-[#1e2024] to-[#23272b] 
                ...
                >
                  <div className="flex justify-between items-center py-6 border-b-2 border-b-gray-900">
                    <div>
                      ...
                      <p className="text-base text-gray-400 mt-3">
                        via Upword- Mar 4, 2015 -Aug 30, 2021 test
                      </p>
                    </div>
                  ...
                  <p className="text-base font-titleFont text-gray-400 font-medium tracking-wide leading-6">
                    ...
                    do. A Lorem import d from ' nesdsk eos et dolor, sed do
                    eiusmod tempor incididunt ut labore et dolore magna aliqua.
                    facilisi. id elit, sed do accusam et dolor.'
                  </p>
                </div>
              </div>
            </div>
